...
from infbench_src.eval_utils import DATA_NAME_TO_MAX_NEW_TOKENS
...
def parse_args() -> Namespace:
    ...
    p.add_argument("--output_dir", type=str, default="../results/infmem", help="Where to dump the prediction results.")  # noqa
    p.add_argument(
        "--model_path",
        type=str,
    ...
    p.add_argument(
        "--model_name",
        type=str,
        choices=["infmem","gpt4", "yarn-mistral", "kimi", "claude2", "rwkv", "yi-6b-200k", "yi-34b-200k", "chatglm3"],
        default="gpt4",
