...
yarn_mistral_templates = {
    ...
    "kv_retrieval": "{context}\n\nThe JSON object's format is \"key\": \"value\", Please extract the value corresponding to the specified key below in the JSON object.\n\n{input}",  # noqa
    "longbook_sum_eng": "Summarize the book below.\n\n{context}\n\nSummary:",  # noqa
    "longbook_choice_eng": "{context}\n\nRead the book and answer the question.\n\nQuestion: {question}\nA. {OPTION_A}\nB. {OPTION_B}\nC. {OPTION_C}\nD. {OPTION_D}\n\nThe letter of the correct answer is",  # noqa
