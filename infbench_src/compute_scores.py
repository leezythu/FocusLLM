...
if __name__ == "__main__":
    ...
    for task in tasks:
        ...
        result_dir = "/bjzhyai03/lizhenyu/activation_beacon_new/data/results/lm/"
        preds_path = result_dir + f"preds_{task}_llama.jsonl"
        # assert preds_path.exists(), f"Predictions not found in: {preds_path}"
        compute_scores(preds_path, task, "llama")
